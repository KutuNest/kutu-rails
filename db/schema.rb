...
ActiveRecord::Schema.define(version: 20170227122428) do
  ...
  create_table "groupements", force: :cascade do |t|
    ...
    t.datetime "created_at",                               null: false
    t.datetime "updated_at",                               null: false
    t.index ["email"], name: "index_groupements_on_email", unique: true, using: :btree
    t.index ["reset_password_token"], name: "index_groupements_on_reset_password_token", unique: true, using: :btree
  end
